...
// isValidPersonName — gates every canonical_persons creation in this scraper
// (testators and heirs). Shared with NameResolver via src/utils so the rule
// cannot drift; required at the top of this file.
