...
CREATE INDEX idx_scraping_queue_submitted_at ON scraping_queue(submitted_at);
CREATE INDEX idx_scraping_queue_category ON scraping_queue(category);
...
CREATE INDEX idx_scraping_sessions_queue_entry ON scraping_sessions(queue_entry_id);
CREATE INDEX idx_scraping_sessions_created_at ON scraping_sessions(created_at);
CREATE INDEX idx_scraping_sessions_category ON scraping_sessions(category);
