    ...
    if (database && database.saveDocument) {
      const consolidatedDoc = {
        ...
        ocr: {
          ...
          service: pageResults[0] && pageResults[0].stages && pageResults[0].stages.ocr ? pageResults[0].stages.ocr.ocrService : 'combined'
        },
        
        enslaved: {
          people: enslavedPeople,
        ...
        ipfs: pageResults[0] && pageResults[0].stages ? pageResults[0].stages.ipfs : null,
