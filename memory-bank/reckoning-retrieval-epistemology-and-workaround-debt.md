...
> A — ALL 7/7 live bypass doors routed through PersonService (climb door 7 closed Jul 1, commit
> 007141de3 — inline blocking keys via a neon-sql adapter; see [[note-climb-resolution-producer-jun27]]). B — frontend build-version surfacing + stale-client
