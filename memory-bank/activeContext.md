...
**Migration Required:**
```bash
PGPASSWORD=<REDACTED-render-pg-decommissioned-2026-04-25> psql -h dpg-d3v78f7diees73epc4k0-a.oregon-postgres.render.com -U reparations_user -d reparations -f migrations/add-extraction-debug-columns.sql
```
